...
export function SnipingUI({ mySnipe, setMySnipe, myRole, whoseTurn, setWhoseTurn, emitMove, state, setState, p1Folded, p2Folded, history }) {
    ...
    <div style={{ textAlign: "center", margin: 24 }}>
      ...
      <button
        ...
        onClick={() => {
          ...
          const updatedSnipes = { ...state.snipes, [myRole]: `${mySnipe.rank} ${mySnipe.type}` };
          ...
          emitMove(
            ...
            p2Folded,
            nextTurn,
            [`${myRole} sniped ${mySnipe.rank} ${mySnipe.type}`, ...history]
          );
